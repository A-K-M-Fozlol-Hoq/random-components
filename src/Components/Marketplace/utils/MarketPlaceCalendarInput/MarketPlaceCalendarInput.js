...
import './MarketPlaceCalendarInput.css';

const MarketPlaceCalendarInput = ( props ) => {
            ...
            return (
              <day 
                ...
                onClick={() => {
                  ...
                  setSelectedDate(d)
                  // console.log('object', new Date(year, month, d));
                }}
              >
                {
...
export default MarketPlaceCalendarInput;