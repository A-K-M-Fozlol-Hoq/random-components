...
const OrderDetails = (props) => {
    ...
    return (
        <div className="order-details-compo-wrapper">
            ...
            <p style={{fontSize:'14px', marginTop: '10px'}}>The vendor can not do the time you requested, please see their suggestions or suggest another timeslot.</p>
            <div style={{width:'150px', border:"1px solid #A34392", borderRadius:'30px', position:'absolute', right:'10px',
                textAlign:'center', padding:'5px 10px'}} onClick={()=>setShowComponent('maintenanceTicket')}>CONFIRM TIME</div>
            <p style={{marginTop:'120px', textAlign:'center', fontWeight:'bold'}}
                onClick={()=>setShowComponent('orderReSchedule')}>RE-SCHEDULE</p>
