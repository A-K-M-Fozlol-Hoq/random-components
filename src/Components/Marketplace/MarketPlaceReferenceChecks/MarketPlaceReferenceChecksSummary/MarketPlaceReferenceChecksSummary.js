    ...
    return (
        <div className="marketplace-ref-check-wrapper" style={{paddingBottom:'200px'}}>
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr 15px', gridGap:'5px', marginTop:'10px',border:'1px solid #3B363B', padding:'10px'
                ...
                <div style={{fontSize:'15px'}}>£2.99 (inc VAT)</div>
                <img style={{width:'100%'}} src={del} alt="" />
            </div>
            <p style={{position:'absolute', right:'10px', fontSize:'14px', marginTop:'30px'}}>Total: <span style={{fontSize:'16px', marginLeft:'20px'}}>£2.99 (inc VAT)</span></p>
